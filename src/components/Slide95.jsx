...
const entryRoles = ['Operations Analyst (Junior)', 'Business Analyst (Junior)', 'Process Analyst'];

const progression = [
  { year: '0–1', designation: 'Ops / Jr BA', salary: '₹30k – ₹45k' },
  { year: '2–3', designation: 'Business Analyst', salary: '₹60k – ₹90k' },
  { year: '4–6', designation: 'Senior BA / Ops Manager', salary: '₹1L – ₹1.4L' },
];

const checks = [
  '✅ Excel + thinking + communication required',
  '✅ Strong defense against AI (decision support role)',
  '❌ Not for people who only like mechanical tasks',
];
...
const Slide95 = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-6 md:px-12 lg:px-20 relative overflow-hidden">
    ...
    <div className="relative z-10 max-w-6xl w-full space-y-8"><motion.div
        ...
        className="space-y-2"
      >
        <h2 className="font-display text-3xl md:text-4xl lg:text-5xl leading-tight">TRACK 2:</h2>
        <p className="text-2xl text-text-muted">Operations / Business Analyst Track</p>
        <p className="text-lg text-text-muted">(Problem-solving, high internal value)</p>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <div className="space-y-3 bg-premium-black/50 border border-white/5 rounded-2xl p-6">
          ...
          <div className="pt-4 space-y-2 text-text-muted">
            <p>7–10 Year Range</p>
            <p>₹15L – ₹25L CTC (strong companies)</p>
          </div>
        </div>
      </motion.div>
      <motion.div
