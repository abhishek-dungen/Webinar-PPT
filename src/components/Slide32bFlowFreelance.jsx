...
const steps = ['Platform', 'Profile', 'Portfolio/Projects', 'Process'];
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
            {steps.map((title, index) => (
              <div key={title} className="relative flex flex-col items-center text-center flex-1">
                ...
                <div className={`${baseCard} opacity-70`}>
                  <div className="flex items-center justify-center w-12 h-12 rounded-full font-semibold bg-transparent border border-white/10 text-white/40">
                    {index + 1}
                  </div>
...
export default Slide32bFlowFreelance;
