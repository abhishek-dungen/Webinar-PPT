...
import bricksImage from '../assets/bricks-ai.jpeg';
import antiGravityImage from '../../AI Tools/maxresdefault (1).jpg';
...
const Slide32ad = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-8 md:px-16 lg:px-24 relative overflow-hidden">
    ...
    <div className="relative z-10 w-full max-w-6xl space-y-10">
      ...
      >
        Use these 2 tools for Dashboards
      </motion.h2>
      <motion.div
      ...
      >
        <div className="rounded-[2.5rem] border border-white/10 bg-black/30 p-6 flex flex-col items-center gap-6 text-center">
          ...
          />
          <p className="text-2xl font-display text-white">Bricks AI</p>
        </div>
        <div className="rounded-[2.5rem] border border-white/10 bg-black/30 p-6 flex flex-col items-center gap-6 text-center">
          <img
            ...
            className="w-full max-w-xs object-contain drop-shadow-[0_15px_50px_rgba(0,0,0,0.55)]"
          />
          <p className="text-2xl font-display text-white">Anti-Gravity</p>
        </div>
      </motion.div>
    </div>
  </section>
