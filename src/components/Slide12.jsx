...
const Slide12 = () => {
    ...
    const bullets = [
        'Ye skill dead hai?',
        'Ye skill AI se replace ho rahi hai?',
        'Ye skill stable hai?',
        'Ya AI ke saath aur powerful ho rahi hai?',
    ];
                ...
                >
                    <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
                        <div className="flex-1 space-y-8">
                            ...
                            >
                                👉 “Kaunsi Skill Worth It Hai — AI Era Mein”
                            </motion.h3>
                            ...
                            >
                                “Aapko ek simple skill-filter milega.”
                            </motion.p>
                            ...
                            <motion.p
                                ...
                                className="text-xl md:text-2xl text-text-muted leading-relaxed"
                            >
                                “Is filter se aap future mein bhi kabhi galat choice nahi karoge.”
                            </motion.p>
                        </div>
