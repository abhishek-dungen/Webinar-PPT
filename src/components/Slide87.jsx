...
const Slide87 = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-8 md:px-16 lg:px-24 relative overflow-hidden">
    ...
    <div className="relative z-10 max-w-6xl w-full space-y-8"><motion.h2
      ...
      >
        👉 “OTT / Content Apps (Netflix / YouTube)”
      </motion.h2>
      <motion.div
      ...
      >
        <p>“Log app install karte hain Par daily use nahi karte”</p>
        <p>Business sawal: 👉 “Episode 1 ke baad log kyun chhod dete hain?”</p>
        <p>Data dekh ke:</p>
