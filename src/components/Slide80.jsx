...
const actions = [
    'Lunch pe riders badhaane hain',
    'Certain areas pe extra support',
    'Kitchens ko align karna',
];
...
const Slide80 = () => (
    <section className="slide-section min-h-screen w/full flex items-center justify-center px-8 md:px-16 lg:px-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl w/full space-y-8"><motion.h2 className="font-display text-4xl md:text-5xl lg:text-6xl leading-tight"
            ...
            >
                👉 STEP 6: Ab Decision Kaise Liya Jaata Hai?
            </motion.h2>
            <motion.div
            ...
            >
                <p>“Company ab yeh decide karti hai:”</p>
                ...
                <p>“Yeh hai: 👉 Data ke base pe decision.”</p>
                <p>Say: “Yahan data paisa bachata hai.”</p>
            </motion.div>
        </div>
