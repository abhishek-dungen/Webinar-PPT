...
const entryRoles = ['Junior Finance Analyst', 'Business Finance Executive', 'Revenue Analyst'];

const progression = [
  { year: '0–2', designation: 'Finance Analyst', salary: '₹35k – ₹50k' },
  { year: '3–5', designation: 'Senior Analyst / Controller', salary: '₹1L – ₹1.5L' },
  { year: '6–10', designation: 'Finance Manager / Head', salary: '₹2L – ₹3L' },
];

const checks = [
  '✅ Commerce background helps',
  '✅ Excel must be rock-solid',
  '❌ Sloppy errors = career death',
];
...
const Slide98 = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-6 md:px-12 lg:px-20 relative overflow-hidden">
    ...
    <div className="relative z-10 max-w-6xl w-full space-y-8"><motion.div
        ...
        className="space-y-2"
      >
        <h2 className="font-display text-3xl md:text-4xl lg:text-5xl leading-tight">TRACK 5:</h2>
        <p className="text-2xl text-text-muted">Finance / Business Finance Support</p>
      </motion.div>
      <motion.div
