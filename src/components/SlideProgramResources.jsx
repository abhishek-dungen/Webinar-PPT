...
const resources = [
  '3000+ PPT Templates (consulting & corporate ready)',
  'Excel Formula Practice Sheet — 75+ formulas with real sample problems',
  'Excel Shortcut Toolkit — 239 high-impact shortcuts',
  'ChatGPT Career Prompt Toolkit — 3464 prompts (jobs, interviews, productivity, growth)',
  'AI Tools Toolkit — 50+ secret, high-leverage AI tools',
];

const SlideProgramResources = () => (
  <section className="slide-section min-h-screen w/full flex items-center justify-center px-6 md:px-12 lg:px-20 relative overflow-hidden">
    ...
    >
      <div className="text-center space-y-3">
        ...
        <p className="text-lg text-text-muted">4️⃣ Premium Resources Bundle</p>
      </div>

      <div className="rounded-[2rem] border border-white/10 bg-white/5 px-6 py-6 shadow-[0_25px_60px_rgba(0,0,0,0.4)] backdrop-blur">
...
export default SlideProgramResources;
