...
const rcaSegments = [
  {
    ...
    text:
      'Reduced manual reporting effort by 40% and improved turnaround time for weekly reports',
  },
  {
    key: 'action',
    ...
    text:
      'by building an automated Excel dashboard using PivotTables, dynamic formulas, and standardized templates',
  },
  {
    key: 'context',
    ...
    text:
      'for an operations team that previously relied on multiple Excel files and manual data consolidation.',
  },
];

const Slide51Step4Example = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-8 md:px-16 lg:px-24 relative overflow-hidden">
    ...
    >
      <p className="text-premium-gold uppercase tracking-[0.6em] text-sm">RCA Example</p>
...
export default Slide51Step4Example;
