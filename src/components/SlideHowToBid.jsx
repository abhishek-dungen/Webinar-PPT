...
const steps = [
  ...
  'Present Your Solution (Outcome-Focused)',
  'Prove Capability',
  'Define Scope & Price',
  'Call to Action',
];
...
const SlideHowToBid = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-6 md:px-12 lg:px-20 relative overflow-hidden">
    ...
    >
      <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-center">How to Bid?</h2>
      <div className="flex flex-col gap-5 max-w-4xl mx-auto text-lg md:text-xl text-white/85">
        {steps.map((step, index) => (
          ...
          >
            ...
            <p className="font-semibold text-white">Step {index + 1} — {step}</p>
          </div>
        ))}
      </div>
    </motion.div>
