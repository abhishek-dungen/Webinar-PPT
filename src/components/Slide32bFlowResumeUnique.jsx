...
const Slide32bFlowResumeUnique = () => (
    ...
    <div className="relative z-10 w-full max-w-6xl space-y-10">
      ...
      >
        ...
        <p className="text-lg text-text-muted">
          Highlighting the Resume stage—because articulation sells your hard work.
        </p>
      </motion.div>
...
export default Slide32bFlowResumeUnique;
