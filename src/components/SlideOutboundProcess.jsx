    ...
    >
      ...
      <div className="flex flex-col gap-3 max-w-4xl mx-auto text-sm md:text-base text-white/85">
        {steps.map((step, index) => (
          <div
            key={step.title}
            className="rounded-3xl border border-white/10 bg-white/5 px-5 py-4 flex flex-col md:flex-row md:items-center gap-2 md:gap-5"
          >
            <div className="text-premium-gold text-base tracking-[0.3em]">
              {index + 1}
            </div>
...
export default SlideOutboundProcess;
