...
import Step2Image from '../../hedaers and pointers CV/Screenshot 2026-01-08 at 5.45.34 PM.png';
...
const Slide51Step2 = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-8 md:px-16 lg:px-24 relative overflow-hidden">
    ...
    >
      <p className="text-premium-gold uppercase tracking-[0.6em] text-sm">Step 2</p>
      <h2 className="font-display text-4xl md:text-5xl leading-tight">
        Make Major Sections of Your Resume
      </h2>
      <div className="w-full flex justify-center">
        <img
          src={Step2Image}
          alt="Resume sections layout example"
