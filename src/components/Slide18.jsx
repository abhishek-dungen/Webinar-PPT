...
const Slide18 = () => {
    const bucketLabel = 'AI ke saath adapt karna';
    const bullets = [
        'Jo sirf instructions follow karte hain',
        'Jo tool samajhte hain, business nahi',
        'Jo value create nahi karte',
    ];
                ...
                >
                    <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
                        <div className="flex-1 space-y-8">
                            ...
                            >
                                👉 “AI Se Darr Nahi — Samajh Chahiye”
                            </motion.h3>
                            ...
                            >
                                “AI logon ko replace nahi karta.”
                            </motion.p>
                            ...
                            <motion.p
                                ...
                                className="text-xl md:text-2xl text-text-muted leading-relaxed"
                            >
                                “AI ke against nahi, AI ke saath grow karna.”
                            </motion.p>
                        </div>
