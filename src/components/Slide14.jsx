...
const Slide14 = () => {
    ...
    const bullets = [
        'Kaun-kaun se job roles mil sakte hain?',
        'Starting salary range kya hoti hai?',
        ' Career progression kaise hota hai?',
        ' In roles ke liye resume kaise banana chahiye?',
        'Resume mein portfolio & projects kaise dikhane chahiye?',
        ' Real-world business projects kaise hote hain?',
        'Interview kaise prepare karte hain?',
    ];
                ...
                >
                    <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
                        <div className="flex-1 space-y-8">
                            ...
                            >
                                Is Skill Se Job Kaise Crack Hoti Hai?
                            </motion.p>
